...
***Duration: 2 turns (Focus)*** - Some spell lack a duration: they simply apply their effect at the time of casting. For spells with a duration, it defines how long the spell's effect stays in place. "Focus" indicates that the spell requires the ongoing concentration of the caster: the caster makes a Willpower roll against any wounds or shock taken (including when bleed damage becomes wounds over time.) If they fail to get result points equal to or greater than damage taken, the spell effect ends at the end of the current phase. If the caster drops, focus spells also end.
